...
=== Removed
* `cleanspeak-search-engine` is no longer distributed as a package. The product still uses ElasticSearch or OpenSearch as before, but you must provide a running search instance yourself. TODO - Reference clean install here.
