...
** Closes https://github.com/CleanSpeak/cleanspeak-issues/issues/7
...
** Closes https://github.com/CleanSpeak/cleanspeak-issues/issues/5
* Improved the OpenID workflow so that we catch more problems with the configuration
** The access token on the token endpoint will be explicitly checked and displays an issue with the token endpoint configuration if it is missing.
** The user info endpoint requires the email field or it will display an issue with the user info endpoint configuration.

=== Fixed
* Fixed the TLD API to use name in the parameters/URI instead of using the one in the body. The API will still accept calls if it is only in the body for compatibility but this is deprecated.
...
** Closes https://github.com/CleanSpeak/cleanspeak-issues/issues/3
* Top level domain UI and link:/docs/3.x/tech/apis/url#retrieve-a-tld[API].
** Closes https://github.com/CleanSpeak/cleanspeak-issues/issues/4
...
** Closes https://github.com/CleanSpeak/cleanspeak-issues/issues/6
