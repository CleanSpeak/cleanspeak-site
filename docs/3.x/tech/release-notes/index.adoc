...
== Technical Preview
_Contact Us for early access_

=== New
* Dirty Mind&trade;, an artificial intelligence model used to assist the CleanSpeak core filter capability.
...
* Removed custom `java.io.tmpdir` environment variable in linux init script.
