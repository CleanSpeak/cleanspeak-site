...
* Support Elasticsearch URLs containing credentials in the user-information portion of a URL that contain URL percent encoded `:`. This is the completed fix for the issue identified and partially resolved in `3.32.2` under ttps://github.com/CleanSpeak/cleanspeak-issues/issues/66[GitHub Issue #66].
