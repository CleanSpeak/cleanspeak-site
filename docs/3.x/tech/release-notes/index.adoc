...
[role=release-note]
== Version 4.1.0
_Released Monday, August 26th, 2024_
...
=== Fixed
* Weekly reports, when run from the cleanspeak/cleanspeak-app Docker image 4.0.2, work properly again. If you do not use the Docker image, then there are no other fixes/enhancements/changes to this release.
