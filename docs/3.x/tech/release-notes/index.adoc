...
[role=release-note]
== Version 4.0.2
_Released Friday, August 9th, 2024_
...
** Severe Toxicity
** Toxicity
** If you have "Expert Mode" enabled on your CleanSpeak instance under Settings->System->Filter, then the scores you have already configured will be preserved. Otherwise, the score mappings will be updated with this release.
