...
|A list of languages this user prefers, ordered from most preferred to least. This is used in generating notifications and emails that are localized for the user. See link:../reference/data-types#locales[Locales].
