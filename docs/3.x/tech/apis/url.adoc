...
[NOTE.deprecated]
====
This version of the update is deprecated as of `3.26.0` and may be removed in a future release.
====

Update a TLD by name in the body
...
include::docs/3.x/tech/apis/tld/_post-request-old.adoc[]
