...
[source]
----
curl -XGET https://example-cleanspeak-api.inversoft.io/system/backup -o backup.zip
----
--
...
[source]
----
curl -XPOST -H 'Content-Type: application/octet-stream' https://example-cleanspeak-api.inversoft.io/system/restore --data-binary @backup.zip
----
--
