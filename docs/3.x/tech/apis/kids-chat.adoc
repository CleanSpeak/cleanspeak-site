...
.URI (4.x)
--
[method]#GET# [uri]#/api/filter/whitelist#
--
...
.URI (4.x)
--
[method]#GET# [uri]#/api/filter/whitelist/allowed/`\{id\}`#
--
...
.URI (4.x)
--
[method]#GET# [uri]#/api/filter/whitelist/allowed``?text=\{text\}&locale=\{locale\}``#
--
...
.URI (4.x)
--
[method]#GET# [uri]#/api/filter/whitelist/allowed``?startRow={startRow}&numberOfResults={numberOfResults}&sort[0].field={sort.field}&sort[0].order={sort.order}``#
--
...
.URI (4.x)
--
[method]#GET# [uri]#/api/filter/whitelist/allowed/search``?text={text}&startRow={startRow}&numberOfResults={numberofResults}``#
--
...
.URI (4.x)
--
[method]#DELETE# [uri]#/api/filter/whitelist/allowed/`\{id\}`#
--
...
.URI (4.x)
--
[method]#POST# [uri]#/api/filter/whitelist/allowed#
--
...
.URI (4.x)
--
[method]#PUT# [uri]#/api/filter/whitelist/allowed/`\{id\}`#
--
...
.URI (4.x)
--
[method]#GET# [uri]#/api/filter/whitelist/tag/``{id}``#
--
...
.URI (4.x)
--
[method]#GET# [uri]#/api/filter/whitelist/tag``?name={name}``#
--
...
.URI (4.x)
--
[method]#GET# [uri]#/api/filter/whitelist/tag#
--
...
.URI (4.x)
--
[method]#DELETE# [uri]#/api/filter/whitelist/tag/``{id}``#
--
...
.URI (4.x)
--
[method]#POST# [uri]#/api/filter/whitelist/tag#
--
...
.URI (4.x)
--
[method]#GET# [uri]#/api/filter/whitelist/disallowed-phrase/``{id}``#
--
...
.URI (4.x)
--
[method]#GET# [uri]#/api/filter/whitelist/disallowed-phrase#
--
...
.URI (4.x)
--
[method]#POST# [uri]#/api/filter/whitelist/disallowed-phrase#
--
...
.URI (4.x)
--
[method]#GET# [uri]#/api/filter/whitelist/disallowed-phrase/advanced/``{id}``#
--
...
.URI (4.x)
--
[method]#GET# [uri]#/api/filter/whitelist/disallowed-phrase/advanced#
--
...
.URI (4.x)
--
[method]#POST# [uri]#/api/filter/whitelist/disallowed-phrase/advanced#
--
