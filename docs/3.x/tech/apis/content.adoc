...
* Filter Content
** <<Filter Content (3.x), CleanSpeak 3.x>>
** <<Filter Content (4.x), CleanSpeak 4.x>>
...
[NOTE]
====
The only difference between the 3.x and 4.x endpoints is the addition of Machine Learning fields in 4.x.
====
...
include::docs/4.x/tech/apis/_filter-content-request-body.adoc[]

=== Response

include::docs/3.x/tech/apis/_filter-content-response-codes.adoc[]

include::docs/4.x/tech/apis/_filter-content-response-body.adoc[]
