...
|See the `enabled` field for what to use for `[model]`. This configures, for the `mild` level, the set of things to do in the event the filter finds a match with a score greater than that in the rule. (It will pick the highest one).
...
|See the `enabled` field for what to use for `[model]`. This configures, for the `medium` level, the set of things to do in the event the filter finds a match with a score greater than that in the rule. (It will pick the highest one).
...
|See the `enabled` field for what to use for `[model]`. This configures, for the `high` level, the set of things to do in the event the filter finds a match with a score greater than that in the rule. (It will pick the highest one).
...
|See the `enabled` field for what to use for `[model]`. This configures, for the `severe` level, the set of things to do in the event the filter finds a match with a score greater than that in the rule. (It will pick the highest one).
