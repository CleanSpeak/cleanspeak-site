...
|[field]#application.notificationServers``[x]``.description# [type]#[String]# [optional]#Optional#
|A description of the notification server and its purpose.

|[field]#application.notificationServers``[x]``.eventsEnabled``[eventType]``# [type]#[Boolean]# [optional]#Optional# [default]#Defaults to true#
