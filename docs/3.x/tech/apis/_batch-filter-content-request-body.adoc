...
|[field]#blacklist.tags# [type]#[Array<String>]# [optional]#Optional#
...
|[field]#contentItems# [type]#[Array<String>]# [required]#Required#
...
|[field]#contentType# [type]#[String]# [optional]#Optional#
...
|[field]#replaceChar# [type]#[Boolean]# [optional]#Optional# [default]#defaults to *#
...
|This parameter enables the whitelist filter. This parameter is unique in that when enabled by setting this parameter to `true` it implicitly disables all other filters. See link: docs/3.x/reference/tech/apis/kids-chat[Whitelist Filter].
|===

[source,json]
.Example Request JSON
----
include::../src/json/content/filter/batch-request.json[]
----