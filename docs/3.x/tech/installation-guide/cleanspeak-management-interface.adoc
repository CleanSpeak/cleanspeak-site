...
image::maintenance-mode-license.png[Maintenance Mode License Page,role=shadowed]
...
image::maintenance-mode-database.png[Maintenance Mode Database Page,role=shadowed]
