...
== Docker Services
In the above example configuration, you will find a database, search, and CleanSpeak service. Read below to bette understand how each service is configured.
