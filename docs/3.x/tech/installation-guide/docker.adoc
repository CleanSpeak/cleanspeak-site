...
You may also wish to connect to a remote database, in that case you will provide your own DBC string URL and you will not require the `db` service in your configuration.
