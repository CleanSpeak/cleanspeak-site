...
To make calls to CleanSpeak, you will need an API Key. These keys allow REST calls to be authenticated and give them controlled access to CleanSpeaks APIs.
