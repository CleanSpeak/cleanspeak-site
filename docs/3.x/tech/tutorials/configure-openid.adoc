...
+
image::fusionauth-app-create.png[Create FusionAuth app, role=shadowed]
...
+
image::fusionauth-app-settings.png[FusionAuth app redirect settings, role=shadowed]
...
+
image::azure-login.gif[Azure login, role="box-shadowed force-rounded fit"]
