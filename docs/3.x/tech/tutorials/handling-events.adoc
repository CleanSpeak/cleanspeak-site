...
Reasons are configured in the management interface via [breadcrumb]#Settings -> User Actions -> Reasons#. This value will be `null` when no reasons are selected or configured.
