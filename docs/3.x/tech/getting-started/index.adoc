...
* [Tech Docs] link:../apis/overview[API docs]
...
If you are using CleanSpeak for a mobile application that has user-generated content, you will need to use 2 different APIs to comply with Apple's and Google's requirements to be approved for the App Store and Play Store. You will also need to write a Notification Handler and enable User Actions in your CleanSpeak deployment. This will allow you to cover all of these requirements:
...
* Have a method for deleting inappropriate content (via Notification Servers)
* Have a method for disabling user accounts that are generating the inappropriate content (via Notification Servers)
...
* [Tutorial] link:../tutorials/filtering-content[Filtering Content]
* [Tutorial] link:../tutorials/handling-flags[Handling Flags]
* [Tutorial] link:../tutorials/handling-notifications[Handling Notifications]
* [Tech Docs] link:../apis/overview[API docs]
...
How do I gain access to the software and my license Id?::
  Login to our accounts section of the web site at https://account.inversoft.com/account/.