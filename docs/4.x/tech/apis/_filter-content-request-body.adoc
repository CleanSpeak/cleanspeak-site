...
|[field]#ml# [type]#[Object]# [optional]#Optional#
|Object that defines Machine Learning options.

|[field]#ml.disabled# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `true`#
...
|[field]#ml.locales# [type]#[List<String>]# [optional]#Optional#
|TBD. Is it a list of string??

|[field]#ml.minimumSeverity# [type]#[String]# [optional]#Optional#
|TBD. sss

|[field]#ml.models# [type]#[List<String>]# [required]#Required#
|Which ML models to pass content through. Valid options are `affinity`, `compassion`, `curiosity`, `identityAttack`, `insult`, `nuance`, `personalStory`, `profanity`, `reasoning`, `respect`, `severeToxicity`, `toxicity`, `threat`. For details on what these mean, see
